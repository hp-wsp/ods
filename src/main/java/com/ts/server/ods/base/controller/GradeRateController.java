...
import com.ts.server.ods.base.controller.form.GradeRateSaveForm;
import com.ts.server.ods.base.controller.form.GradeRateUpdateForm;
...
public class GradeRateController {
    ...
    @Autowired
    public GradeRateController(GradeRateService service) {
